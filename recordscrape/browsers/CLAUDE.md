...
- An announcement cut short by a navigation or by the browser closing is dropped silently, matched by error message because Patchright exports no error type for either. Any other announce error still raises.
